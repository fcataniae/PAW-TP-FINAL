		...
		<form action="{{ route('in.users.actualizar.datospersonal', [$empleado->id]) }}" method="POST">
			...
			<fieldset name="datos-personales">
				...
				<div class="group size-2 sangria">
					<label>Nombre: </label>
					<input type="text" id="nombre" name="nombre" value="{{ $empleado->nombre }}" class="input size-12" readonly>
				</div>
				<div class="group size-3 sangria">
					<label>Apellido: </label>
					<input type="text" id="apellido" name="apellido" value="{{ $empleado->apellido }}" class="input size-12" readonly>
				</div>
				<div class="group-inline size-3 sangria">
					<label>Documento: </label>
					<br>
					<input type="text" id="nro_documento"id="tipo_documento" name="tipo_documento" value="{{ $tipoDocumento->descripcion }}" class="input size-2" readonly>
					<input type="number" id="nro_documento" name="nro_documento" min="0" value="{{ $empleado->nro_documento }}" class="input size-6" readonly>
				</div>
				<div class="group size-2 sangria">
					<label>CUIL: </label>
					<input type="number" id="cuil" name="cuil" min="0" value="{{ $empleado->cuil }}" class="input size-12" readonly>
				</div>
			</fieldset>
			<br>
